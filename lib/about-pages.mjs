...
export const aboutRedirects = Object.freeze([
  ...Object.entries(ABOUT_PAGE_MOVES).map(([source, destination]) => ({ source, destination: withTrailingSlash(destination), permanent: true })),
  { source: `${ABOUT_ROOT_PATH}/bewertungen-und-erfahrungen`, destination: withTrailingSlash(ABOUT_REVIEWS_PATH), permanent: true },
